...
//	        } 
	...
	private static void run(SOURCE_TYPE sourceType, boolean isLinux, boolean keepTemp, boolean isVerbose) throws IOException {
        ...
        try {
			...
			String runJavaDoc = String.format("javadoc -doclet com.websecuritylab.netdoc.doclet.Main -docletpath lib/net-doc-jee-doclet.jar -subpackages %s -sourcepath \"%s\" -classpath \"%s\" ", subPackages, decompiledPath, classPath);
...
//			
//			String runJavaDoc = String.format("javadoc -doclet com.websecuritylab.tools.netdoc.JeeScannerDoclet -docletpath lib/net-doc-jee-doclet.jar -subpackages %s -sourcepath %s -classpath \"./lib/*;%s/*\"", subPackages, sourceDir, classPath);
...
//
//			
//			//String runJavaDoc = String.format("javadoc -doclet com.websecuritylab.tools.netdoc.JeeScannerDoclet -docletpath lib/net-doc-jee-doclet.jar -subpackages %s -sourcepath %s\\WEB-INF\\classes -classpath \"./lib/*;%s\\WEB-INF\\lib\\*\"", props.getProperty(CliOptions.SUBPACKAGES), tempDir2.getAbsolutePath(), tempDir2.getAbsolutePath());
//			String runJavaDoc = String.format("javadoc -doclet com.websecuritylab.tools.netdoc.JeeScannerDoclet -docletpath lib/net-doc-jee-doclet.jar -subpackages %s -sourcepath \"%s\" -classpath \"%s\" ", subPackages, decompiledPath, classpath);
//			log.debug("Running: " + runJavaDoc);
//			String gotOutput = Util.runCommand(isLinux, runJavaDoc);
//			
//			String START_AFTER = "Constructing Javadoc information...";
